...
(432, 456, 'Product Manager', 'Product manager oversees the development and lifecycle of a product from conception to launch and beyond.'),
(231, 456, 'Product Manager', 'Product manager oversees the development and lifecycle of a product from conception to launch and beyond.');
